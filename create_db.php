...
$sql_query="CREATE TABLE customers (id int(6) NOT NULL auto_increment,username varchar(20),password varchar(40),salt varchar(8),first varchar(15) NOT NULL,last varchar(15) NOT NULL,
...
$sql_query = "INSERT INTO customers VALUES ('','JeNoZ','monkey123','salt','John','Smith','2nd Street','22220','Iceland','01234 567891')";
mysql_query($sql_query);
mysql_close();
